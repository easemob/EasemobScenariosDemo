...
import com.hyphenate.scenarios.databinding.DemoActivityMeInformationEditBinding
...
open class EditUserNicknameActivity:EaseBaseActivity<DemoActivityMeInformationEditBinding>() {
    ...
    open fun initTitle(){
        binding.run {
            titleBar.setTitle(getString(R.string.em_self_information_edit_nick_name))
            selfProfile?.let {
        ...
        binding.inputNameCount.text = resources.getString(
            R.string.em_self_information_change_name_count
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                if (length == 0){
                    binding.inputNameCount.text =
                        resources.getString(R.string.em_self_information_change_name_count, 0)
                }else{
                    binding.inputNameCount.text =
                        resources.getString(R.string.em_self_information_change_name_count, length)
