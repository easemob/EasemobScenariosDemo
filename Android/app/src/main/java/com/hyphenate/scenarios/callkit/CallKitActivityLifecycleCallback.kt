...
import com.hyphenate.scenarios.callkit.extensions.isTargetActivity
import com.hyphenate.scenarios.callkit.extensions.makeTaskToFront
import com.hyphenate.scenarios.callkit.window.EMCallFloatWindow
import com.hyphenate.scenarios.interfaces.ActivityState
import com.hyphenate.scenarios.ui.login.SplashActivity
...
//            EM1v1CallKitManager.receiveCallPush(activity)
        }
    }
...
//            if (a != null && a.isTargetActivity() && !EMCallFloatWindow.isShowing()) {
//                a.makeTaskToFront()
//            }
    ...
    private fun restartSingleInstanceActivity(activity: Activity) {
        ...
        if (resumeActivity.size >= 1 && activityList.size > 1) {
            ...
            if (//当前activity和列表中首个activity不相同
                a != null && !a.isFinishing && a !== activity && a.taskId != activity.taskId && !EMCallFloatWindow.isShowing()) {
